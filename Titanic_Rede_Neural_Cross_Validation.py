...
resultado_rede_neural_CV = pd.DataFrame({'PassengerId': resultado.PassengerId, 'Survived': novos_resultados})
resultado_rede_neural_CV.to_csv('resultado_rede_neural_CV.csv', index=False)
